...
import person from '../../../assets/index-page/person.png'
...
const AffiliateProgram = (props) => {
    return (
        <>
            <div className={css.affiliateProgram}>
                <div className="container">
                    <div className={css.inner}>
                        <h2 className={css.title}>Affiliate Program</h2>
                        <h3 className={css.subtitle}><span className={css.mark}>5 types</span> of Bonuses</h3>
            ...
            <div className={css.rankAndTeamBonus}>
                <div className="container">
                    <div className={css.rankAndTeamTable}>
                        <h2 className={css.rankTitle}><span className={css.mark}>Rank</span> Bonus and <span className={css.mark}>Team</span> Bonus</h2>
                ...
                <div className="container">
                    <div className={css.rankAndTeamBonusInner}>
                        <div className={css.rankAndTeamTable + ' ' + css.conditions}>
                            <h2 className={css.rankTitle}>Conditions for Reaching <span className={css.mark}>Rank</span></h2>
                            <div className={css.tableContent}>
                                <div className={css.tableRank}>
                                    <h3 className={css.columnTitle}>Rank</h3>
                                    <span>Rank 1</span>
            ...
            <div className={css.teamBonusSection}>
                <div className="container">
                    <div className={css.teamBonusInner}>
                        <h2 className={css.rankTitle}><span className={css.mark}>Team</span> Bonus Example</h2>
                        <div className={css.teamBonusExample}>
                            ...
                            <div className={css.exampleLine}>
                                ...
                                <div className={css.people}> 
                                    <div className={css.person}>
                                        ...
                                        <img src={partnerTwo} alt="partner 2" />
                                        <p>Partner 2</p>
                            ...
                            <div className={css.exampleLine}>
                                ...
                                <div className={css.people}> 
                                    <div className={css.person}>
                                        <img className={css.topLine} src={lineOnThirdLine} />
                                        <img src={partnerFive} alt="partner 5" />
                                        <p>Partner 5</p>
                                        <h3 className={css.partnerText}>Binary Bonus of <span>3,000</span> USDC received</h3>
                                    </div>
                                    <div className={css.person}>
                                        <img className={css.topLine + ' ' + css.inverted + ' ' + css.lineBottom} src={lineOnThirdLine} />
                                        <img src={partnerSix} alt="partner 6" />
                                        <p>Partner 6</p>
                                        <h3 className={css.partnerText}>Binary Bonus of <span>3,000</span> USDC received</h3>
                                    </div>
                                </div> 
